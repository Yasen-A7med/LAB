...
const projects: ProjectCardData[] = [
  {
    ...
    desc: 'Extract and render exported WhatsApp ZIP archives with real conversation UI, stickers, Opus voice notes, photos, search and media gallery.',
    icon: WhatsAppIcon,
    tag: 'Chat Suite',
    iconColor: 'text-[#00a884]',
    iconBg: 'bg-[#00a884]/10 border-[#00a884]/20',
    glowColor: 'group-hover:shadow-[#00a884]/20 group-hover:border-[#00a884]/40',
    btnText: 'Open Chat Viewer',
    badgeText: 'ZIP & Media'
  },
  {
    id: 'yd',
